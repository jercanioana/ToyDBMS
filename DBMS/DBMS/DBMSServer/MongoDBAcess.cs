    ...
    class MongoDBAcess
    {
        ...
        private void CreateDBConnection()
        {
            try
            {
                ...
                var settings = MongoClientSettings.FromConnectionString("mongodb+srv://vlad:1234@cluster0.xauae.mongodb.net/" + DatabaseName + "?retryWrites=true&w=majority");
        ...
        public void CreateCollection(string collectionName)
        {
            try
            {
                //Console.WriteLine(MongoDatabase.ToString());
